...
public class TEST_ByteWriteDiskStore {
	...
	public void tester(){
		...
		assertThat(next.getPrevShaHash(),equalTo(block.getShaHash()));
	...
	public void getHashesOne() throws Exception{
		...
		boolean t = Arrays.equals(result, blocks.get(0).getHeaderHash());
	...
	public void getHashesB() throws Exception{
		...
		for(int i=0;i<100000;i++){
			...
			boolean t = Arrays.equals(temp.getHeaderHash(),
					buf);
